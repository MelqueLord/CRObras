...
public record AtualizarParcelaRequest(decimal Valor, DateOnly DataVencimento);
...
public record AtualizarVendaRequest(TipoVenda Tipo, decimal ValorTotalNegociado, DateOnly DataVenda, string CompradorNome);
...
public record AtualizarPermutaRequest(TipoAtivoPermuta Tipo, string Descricao, decimal ValorEstimado, string? DocumentoReferencia, DateOnly DataRecebimento, StatusAtivoPermuta Status);
public record AtualizarStatusPermutaRequest(StatusAtivoPermuta Status);
