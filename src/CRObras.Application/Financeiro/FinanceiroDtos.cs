...
public record MovimentacaoResponse(Guid Id, Guid ObraId, TipoMovimentacao Tipo, string Categoria, decimal Valor, DateOnly DataMovimentacao, string Descricao, Guid? SocioId, Guid? ParcelaReceberId, StatusMovimentacao Status, DateTimeOffset CriadoEm, string? Fornecedor);
